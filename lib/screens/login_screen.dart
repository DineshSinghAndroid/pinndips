...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ,             prefix: Icon(Icons.email,color:AppTheme.textColor,),
                  ...
                  addHeight(47.h),
                  const CommonTextFieldWidget(hint: "Enter Your Password"
                    ,prefix: Icon(Icons.key,color: AppTheme.textColor,),
                  ),
                  addHeight(47.h),
                  Row(
                  ...
                  addHeight(59.h),
                  commonButton1("Log in",(){  Get.toNamed(MyRouter.signUpScreen);}),
                  ...
                  Container(
                    height: 286.h,
                    width: 267.w,
                    decoration: const BoxDecoration(image: DecorationImage(image: AssetImage(Ig.loginChartImg))),)
                ],
              ),
            )
          ),
